/*
  # Teams Management and Analytics Enhancement

  1. New Tables
    - `team_members` - Junction table for team membership
    - Enhanced teams structure for better management
  ...
  3. Changes
    - Add team membership tracking
    - Create default Super Admins team
    - Add analytics support structures
*/
...
-- Add public read access to organisations for domain validation
